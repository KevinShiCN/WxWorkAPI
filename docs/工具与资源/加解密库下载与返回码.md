---
title: "加解密库下载与返回码"
source: "https://developer.work.weixin.qq.com/document/path/90307"
...
[xml版本(2018年10月11日更新,点击下载)](https://open.work.weixin.qq.com/wwopen/downloadfile/c++.zip)
...
[json版本[(2020年9月1日更新,点击下载)]](https://codeload.github.com/workweixin/weworkapi_cplusplus/zip/master)
...
[xml版本(2018年10月11日更新,点击下载)](https://open.work.weixin.qq.com/wwopen/downloadfile/java.zip)
...
[https://commons.apache.org/proper/commons-codec/download_codec.cgi](https://commons.apache.org/proper/commons-codec/download_codec.cgi)
- 异常java.security.InvalidKeyException:illegal Key Size的解决方案：在官方网站下载JCE无限制权限策略文件（请到官网下载对应的版本， 例如JDK7的下载地址：[https://www.oracle.com/technetwork/java/javase/downloads/jce-7-download-432124.html](https://www.oracle.com/technetwork/java/javase/downloads/jce-7-download-432124.html) )：下载后解压，可以看到local_policy.jar和US_export_policy.jar以及readme.txt。
如果安装了JRE，将两个jar文件放到%JRE_HOME% \lib\security目录下覆盖原来的文件，如果安装了JDK，将两个jar文件放到%JDK_HOME%\jre\lib\security目录下覆盖原来文件。

[json版本(2020年9月1日更新,点击下载](https://codeload.github.com/workweixin/weworkapi_java/zip/master)
...
[(2018年10月11日更新,点击下载)](https://open.work.weixin.qq.com/wwopen/downloadfile/csharp.zip)
...
[xml版本(2019年1月18日更新,点击下载)](https://github.com/sbzhu/weworkapi_golang/archive/master.zip)
...
[json版本(2020年9月1日更新,点击下载](https://codeload.github.com/workweixin/weworkapi_golang/zip/master)
