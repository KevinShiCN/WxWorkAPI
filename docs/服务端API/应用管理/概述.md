---
title: "概述"
source: "https://developer.work.weixin.qq.com/document/path/90226"
...
.apps_stage {		overflow:hidden;	}	.apps_stage br {		display:none;	}	.apps_items {		margin-bottom:-30px;	}	.apps_item {		overflow:hidden;		margin-bottom:30px;	}	.apps_item_icon {		float:left;		margin-right: 24px;		margin-top: 5px;	}	.apps_item_rightCan {		overflow:hidden;		color: #333333;		font-size:14px;	}	.apps_item_name {		font-weight:bold;	}	.apps_item_desc ul{		margin-bottom:0;	}	@media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min-device-pixel-ratio: 2) {		.AppsEnterpriseImg {			content: url("https://res.mail.qq.com/node/ww/wwopenmng/images/independent/doc/AppsEnterprise_2x.png")		}	}
企业微信的应用具备以下能力：
