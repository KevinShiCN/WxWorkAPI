---
title: "获取汇报记录详情"
source: "https://developer.work.weixin.qq.com/document/path/93394"
...
| docs | 文档内容 |
| └ docid | 文档的docid |
| └ doc_url | 文档的访问链接注：企业微信4.0.20版本后，不会有新增的文档控件数据。开发者可通过此url进一步查看/导出文档 |
...
| └ fileid | 微盘的fileid，可通过下载微盘文件 接口下载文件 |
