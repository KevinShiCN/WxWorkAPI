---
title: "修改预约会议"
source: "https://developer.work.weixin.qq.com/document/path/99047"
last_update: ""
...
| type | 是 | 会议的类型，1：表示视频会议，2：表示语音会议  （老的微会议字段，腾讯会议不需要了，发布时删掉） |
| description | 否 | 会议的描述，最多支持500个字节或者utf8字符 |
| remind_time | 否 | 指定会议开始前多久提醒用户，相对于meeting_start前的秒数，默认为0 |
