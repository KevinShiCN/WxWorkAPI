---
title: "PSTN 外呼状态更新事件"
source: "https://developer.work.weixin.qq.com/document/path/98774"
...
| FromUserName | 操作者UserID。如果为系统触发事件，默认为sys；如果为成员操作事件，仅当是企业成员时有值。 |
...
| MeetingId | 会议ID |
| PstnStatus | PSTN外呼状态。START_INVITE: 开始邀请START_ACCEPT: 用户接听LEAVE_WITHOUT_ACCEPT: 用户无接听挂断或拒绝LEAVE_WITH_ACCEPTED: 用户已接听挂断CANCLE_INVITE: 呼叫中邀请人主动取消 |
