---
title: "签名算法"
source: "https://developer.work.weixin.qq.com/document/path/90281"
last_update: ""
...
第二步: 在stringA最后拼接上企业微信管理端”企业支付”这个应用的secret，得到stringSignTemp字符串，并对stringSignTemp进行MD5运算，再将得到的字符串所有字符转换为大写，得到sign值signValue。
