---
title: "查询红包记录"
source: "https://developer.work.weixin.qq.com/document/path/90276"
...
**参数说明：**
table{    table-layout:fixed;}table th:first-of-type {    width: 14%;}table th:nth-of-type(2) {    width: 14%;}table th:nth-of-type(3) {    width: 14%;}table th:nth-of-type(4) {    width: 14%;}table th:nth-of-type(5) {    width: 14%;}
