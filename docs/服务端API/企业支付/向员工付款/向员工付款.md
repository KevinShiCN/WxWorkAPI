---
title: "向员工付款"
source: "https://developer.work.weixin.qq.com/document/path/90278"
...
**参数说明：**
table{    table-layout:fixed;}table th:first-of-type {    width: 14%;}table th:nth-of-type(2) {    width: 14%;}table th:nth-of-type(3) {    width: 14%;}table th:nth-of-type(4) {    width: 14%;}table th:nth-of-type(5) {    width: 14%;}td{word-break: break-all;}
...
| CA_ERROR | 证书出错 | 请求没带证书或者带上了错误的证书 | 1.到商户平台下载证书 2.请求的时候带上该证书3.请通过查询接口确认此次付款结果；如果要重试，请使用原商户订单号+原参数重试，避免重复付款。 |
