---
title: "全量覆盖部门"
source: "https://developer.work.weixin.qq.com/document/path/90982"
...
本接口以partyid为键，全量覆盖企业的通讯录组织架构，任务完成后企业的通讯录组织架构与提交的文件完全保持一致。请先下载CSV文件([下载全量覆盖部门模版](https://work.weixin.qq.com/wework_admin/downloadfile/batch_party_sample.csv))，根据需求填写文件内容。
