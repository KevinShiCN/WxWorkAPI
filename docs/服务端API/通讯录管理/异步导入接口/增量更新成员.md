---
title: "增量更新成员"
source: "https://developer.work.weixin.qq.com/document/path/90980"
...
本接口以userid（账号）为主键，增量更新企业微信通讯录成员。请先下载CSV模板([下载增量更新成员模版](https://work.weixin.qq.com/wework_admin/downloadfile/batch_user_sample.csv))，根据需求填写文件内容。
