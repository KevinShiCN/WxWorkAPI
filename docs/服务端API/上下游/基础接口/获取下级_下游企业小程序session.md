...
source: "https://developer.work.weixin.qq.com/document/path/95817"
...
| userid | 是 | string | 通过code2Session接口获取到的加密的userid不多于64字节 |
| session_key | 是 | string | 通过code2Session接口获取到的属于上级/上游企业的会话密钥-不多于64字节 |
