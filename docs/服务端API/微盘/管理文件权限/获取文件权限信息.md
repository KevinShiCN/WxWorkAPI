---
title: "获取文件权限信息"
source: "https://developer.work.weixin.qq.com/document/path/97891"
last_update: ""
...
| corp_internal_auth | uint32 | 企业内权限信息普通文档： 1:仅浏览（可下载) 4:仅预览（仅专业版企业可设置）；如果不填充此字段为保持原有状态微文档： 1:仅浏览（可下载）；如果不填充此字段为保持原有状态 |
| enable_corp_external | bool | 是否为企业外可访问 |
| corp_external_auth | uint32 | 企业外权限信息普通文档： 1:仅浏览（可下载) 4:仅预览（仅专业版企业可设置）；如果不填充此字段为保持原有状态微文档： 1:仅浏览（可下载）；如果不填充此字段为保持原有状态 |
