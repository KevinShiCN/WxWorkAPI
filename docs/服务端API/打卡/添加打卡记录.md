---
title: "添加打卡记录"
source: "https://developer.work.weixin.qq.com/document/path/99647"
last_update: ""
...
可通过接口写入来自非打卡应用、企业微信考勤机产生的打卡记录，写入数据，匹配规则后可在企业微信打卡明细、统计中参与展示。
...
| wifimac | 传入wifi名称时必填 | 打卡的MAC地址/bssid 满足正则表达式^[A-Fa-f0-9]{2}:[A-Fa-f0-9]{2}:[A-Fa-f0-9]{2}:[A-Fa-f0-9]{2}:[A-Fa-f0-9]{2}:[A-Fa-f0-9]{2}$ |
