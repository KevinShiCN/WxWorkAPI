---
title: "获取审批申请详情"
source: "https://developer.work.weixin.qq.com/document/path/91983"
...
| 参数 | 说明 |
| --- | --- |
| tips_content | 说明文字内容，可参考获取审批模板详情 -「附7：Tips控件（说明文字控件）config说明」一节说明 |
...
| └ file_id | 文件的media_id，微盘文件无法获取，具体使用请参考：文档-获取临时素材 |
...
| 参数 | 说明 |
| --- | --- |
| account_type | 账户类型 ：1： 对公账户2： 个人账户 |
| account_name | 账户名 |
| account_number | 账号 |
| remark | 备注 |
| bank | 银行信息 |
