---
title: "入群欢迎语素材管理"
source: "https://developer.work.weixin.qq.com/document/path/92366"
...
| file.media_id | 是 | 文件id，可以通过素材管理、异步上传临时素材接口获得 |
| video.media_id | 是 | 视频媒体文件id，可以通过素材管理、异步上传临时素材接口获得 |
