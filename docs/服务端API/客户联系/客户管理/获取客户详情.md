---
title: "获取客户详情"
source: "https://developer.work.weixin.qq.com/document/path/92114"
...
| 代开发应用 | 具有「客户基础信息」权限 |
| 第三方应用 | 具有「客户基础信息」权限营销获客类应用具有「建联客户信息」权限 |
...
- 登录企业的管理后台-客户联系-客户-api（注：若企业管理端没有客户联系的入口，而是家校沟通的入口，则通过 家校沟通-家校沟通-api ），点击绑定去到微信公众平台进行授权，支持绑定公众号和小程序（需要同时绑定微信开放平台）；绑定的公众号或小程序主体需与企业微信主体一致，暂且支持绑定一个
![](https://wework.qpic.cn/wwpic3az/93466_2xfwJ7ecS9ukZK-_1723016212/0)
- 绑定完成，即可通过接口获取微信联系人所对应的微信unionid
