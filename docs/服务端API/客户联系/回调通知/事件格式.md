---
title: "事件格式"
source: "https://developer.work.weixin.qq.com/document/path/92130"
...
- 接收客户接替失败事件的应用，需具有“企业客户权限->客户联系->分配在职或离职成员的客户”权限
- 接收企业客户标签创建事件、企业客户标签变更事件、企业客户标签删除事件的应用，需具有“企业客户权限->客户联系->管理企业客户标签”权限
...
外部联系人添加了配置了客户联系功能且开启了**免验证**的成员时（此时成员尚未确认添加对方为好友），回调该事件
