---
title: "概述"
source: "https://developer.work.weixin.qq.com/document/path/100507"
...
- 解密使用的算法为 AES-128-CBC，数据采用PKCS#7填充。
- 对称解密的目标密文为 Base64_Decode(encryptedData)。
- 对称解密秘钥 aeskey = Base64_Decode(应用身份使用的ticket), aeskey长度为16字节。
