---
title: "进入会议"
source: "https://developer.work.weixin.qq.com/document/path/93807"
...
|  | 属性 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- | --- |
|  | meetingId | string | 否 | 会议 ID，可通过创建预约会议或通过调用ww.startMeeting()获取 为空的情况下创建快速会议 |
