---
title: "打开会话"
source: "https://developer.work.weixin.qq.com/document/path/92525"
...
|  | externalUserIds | string \| string[] | 否 | 参与会话的外部联系人列表通过 selectExternalContact 接口获得 | 企业微信 2.4.20 |
|  | chatId | string | 否 | 打开已有会话的 chatId目前仅支持打开客户群，若传入则忽略其他参数使用该参数必须使用应用身份注册 | 企业微信 3.0.36 |
...
|  | chatId | string | 是 | 当前群聊 ID使用应用身份注册的场景下返回 | 企业微信 3.0.36 |
