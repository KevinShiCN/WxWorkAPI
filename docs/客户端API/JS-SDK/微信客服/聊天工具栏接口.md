---
title: "聊天工具栏接口"
source: "https://developer.work.weixin.qq.com/document/path/94764"
...
getContext接口使用说明详见“ww.getContext”，在微信客服的工具栏里返回的`entry`值是`single_kf_tools`具体如下：
...
对于 分享消息到当前会话接口，微信客服工具栏额外支持`msgmenu`和`channels_shop_product`的消息类型，具体如下：
