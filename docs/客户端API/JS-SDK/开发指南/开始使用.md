---
title: "开始使用"
source: "https://developer.work.weixin.qq.com/document/path/90514"
...
在需要调用JS接口的页面引入如下JS文件：[https://res.wx.qq.com/open/js/jweixin-1.2.0.js](https://res.wx.qq.com/open/js/jweixin-1.2.0.js)
