---
title: "在小程序中加入群聊"
source: "https://developer.work.weixin.qq.com/document/path/93884"
...
- 开发者在小程序后台添加插件，添加路径：小程序后台 - 设置 - 第三方设置 - 添加插件中，搜索ID: wx4d2deeab3aed6e5a。
- 开发者在小程序app.json 文件中添加对插件的引用
